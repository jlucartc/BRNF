...
module TagLambdas
  ...
  LAMBDAS = {
  	...
  	"//xs:enviNFe//xs:NFe" => lambda{|msg,xml|},
  	"//xs:consReciNFe" => lambda{|msg,xml|},
  	"//xs:consReciNFe//@versao" => lambda{|msg,xml|},
  	...
  	"//xs:inutNFe" => lambda{|msg,xml|},
  	"//xs:inutNFe//@versao" => lambda{|msg,xml|},
  	"//xs:inutNFe//xs:infInut" => lambda{|msg,xml|},
  	...
  	"//xs:consSitNFe" => lambda{|msg,xml|},
  	"//xs:consSitNFe//@versao" => lambda{|msg,xml|},
  	...
  	"//xs:consSitNFe//xs:xServ" => lambda{|msg,xml|
  	...
  	"//xs:consStatServ" => lambda{|msg,xml|},
  	"//xs:consStatServ//@versao" => lambda{|msg,xml|},
  	...
  	"//xs:consStatServ//xs:xServ" => lambda{|msg,xml|
  		servico_xml_tag = xml.xpath("//xs:consStatServ//xs:xServ","xs" => "http://www.portalfiscal.inf.br/nfe").first
  		servico_xml_tag.content = msg[:servico]
  	},
  	"//xs:ConsCad" => lambda{|msg,xml|},
  	"//xs:ConsCad//@versao" => lambda{|msg,xml|},
  	"//xs:ConsCad//xs:infCons//xs:xServ" => lambda{|msg,xml|
  	...
  	"//xs:distDFeInt//xs:consNSU" => lambda{|msg,xml|},
  	...
  	"//xs:distDFeInt//xs:consChNFe" => lambda{|msg,xml|},
  	...
  	"//xs:envEvento//@versao" => lambda{|msg,xml|},
  	...
  	"//xs:envEvento//xs:evento//@versao" => lambda{|msg,xml|},
  	...
  	"//xs:envEvento//xs:evento//xs:infEvento//xs:verEvento" => lambda{|msg,xml|
  	...
  	"//xs:envEvento//xs:evento//xs:infEvento//xs:detEvento" => lambda{|msg,xml|},
  	...
  	"//xs:envEvento//xs:evento//xs:infEvento//xs:detEvento//@versao" => lambda{|msg,xml|
  	...
  	"//xs:envEvsento//xs:evento//xs:infEvento//xs:detEvento//xs:xJust" => lambda{|msg,xml|
  	...
  	"//xs:enviNFe//xs:NFe//xs:infNFe//xs:det//xs:imposto//xs:ICMS//xs:ICMS00//xs:pICMS" => lambda{|msg,xml|
  		...
  		imposto_xml_tags.each_with_index do |imposto_xml_tag,index|
  			...
  			if !icms00_xml_tag.nil?
  				...
  				aliquota_xml_tag.content = "%.2f" % icms[:aliquota_icms]
  	...
  	"//xs:enviNFe//xs:NFe//xs:infNFe//xs:det//xs:imposto//xs:ICMS//xs:ICMS10//xs:pICMSST" => lambda{|msg,xml|
  		...
  		imposto_xml_tags.each_with_index do |imposto_xml_tag,index|
  			...
  			if !icms10_xml_tag.nil?
  				...
  				aliquota_icmsst_xml_tag.content = "%.2f" % icms[:aliquota_icms_st]
  	...
  	"//xs:enviNFe//xs:NFe//xs:infNFe//xs:det//xs:imposto//xs:ICMS//xs:ICMS60//xs:pICMSEfet" => lambda{|msg,xml|
  		...
  		imposto_xml_tags.each_with_index do |imposto_xml_tag,index|
  			...
  			if !icms60_xml_tag.nil?
  				...
  				percentual_icms_efetivo_xml_tag.content = "%.2f" % icms[:aliquota_icms]
  	...
  	"//xs:enviNFe//xs:NFe//xs:infNFe//xs:det//xs:imposto//xs:ICMS//xs:ICMSST//xs:pICMSEfet" => lambda{|msg,xml|
  		...
  		imposto_xml_tags.each_with_index do |imposto_xml_tag,index|
  			...
  			if !icmsst_xml_tag.nil?
  				...
  				aliquota_efetiva_xml_tag.content = "%.2f" % icms[:aliquota_icms]
